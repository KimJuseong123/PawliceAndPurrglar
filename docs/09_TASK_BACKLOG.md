...
| SUBMIT-005 | **P0** | WIP | 라이선스 정리 — `THIRD_PARTY_NOTICES.md`에 모델·효과음·폰트·엔진 기록 완료. **남은 것: BGM 미정, Tripo 증빙 4종 보관, 그리고 2026-08-09에 들어온 효과음 11종의 출처·라이선스 (`docs/17`에 "미확인"으로 열한 줄이 비어 있다)** |
