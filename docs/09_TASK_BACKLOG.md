...
| TECH-002 | P0 | TODO | Blender 모델, 리그, 애니메이션 연동 검증 |
| TECH-003 | P1 | REVIEW | 마이크와 음성 텍스트 변환 검증 필요성 결정 |
...
| ID | 우선순위 | 상태 | 작업 |
|---|---|---|---|
| MATCH-001 | P0 | TODO | 경기 상태 정의 |
| MATCH-002 | P0 | TODO | 준비 카운트다운 |
| MATCH-003 | P0 | TODO | 4분 타이머 |
...
| ID | 우선순위 | 상태 | 작업 |
|---|---|---|---|
| PLAYER-001 | P0 | TODO | 경찰 이동 |
| PLAYER-002 | P0 | TODO | 도둑 이동 |
...
| ID | 우선순위 | 상태 | 작업 |
|---|---|---|---|
| ART-001 | P2 | BLOCKED | 최종 캐릭터와 동물 모델 |
...
1. `TECH-002` Blender 모델, 리그, 애니메이션 연동 검증
2. `TECH-003` 마이크와 음성 텍스트 변환 검증 필요성 결정
